...
function updateName(string memory _name) public {
 ...
 //only the owner of the contract can modify the contracts
 modifier onlyOwner() {
...
To make this smart contract permissionless, you could remove the onlyOwner modifier and use
The Graph to index and query posts by owner.
*/
